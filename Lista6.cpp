//implemente un programa que elimine datos repetidos en de un vector de listas
...
void digitoRepetido(Lista listas[]){

}
void GenerarListas(int nums[] , Lista lis[], int n1){   //individualizacion de digitos 
    int aux;                
